var thermocoupleList = ["J-Type", "K-Type", "T-Type", "E-Type", "N-Type", "R-Type", "S-Type"];
...
var r = ["Platinum-13% Rhodium Pt-13% Rh", "Platinum Pt", "r.png", "32 to 2642°F", "0 to 1450°C", "–58 to 3214°F", "–50 to 1768°C", "–0.226 to 21.101", "greater of 1.5°C or 0.25%", "greater of 0.6°C or 0.1%", "r-iec.png", "Oxidizing or Inert. Do Not Insert in Metal Tubes. Beware of Contamination. High Temperature"];
var s = ["Platinum-10% Rhodium Pt-10% Rh", "Platinum Pt", "s.png", "32 to 2642°F", "0 to 1400°C", "–58 to 3214°F", "–50 to 1768°C", "–0.236 to 18.693", "greater of 1.5°C or 0.25%", "greater of 0.6°C or 0.1%", "s-iec.png", "Oxidizing or Inert. Do Not Insert in Metal Tubes. Beware of Contamination. High Temperature"];
...
function showTheDamnNumber() {
    ...
    if (tcouple == "R-Type") {
        ...
        document.getElementById("iec584_3").src                  = 'img/' + r[10];
        document.getElementById("comments").innerHTML            = '<strong>Comments: </strong>' + r[11];
    }
    ...
    if (tcouple == "S-Type") {
        ...
        document.getElementById("iec584_3").src                  = 'img/' + s[10];
        document.getElementById("comments").innerHTML            = '<strong>Comments: </strong>' + s[11];
    }
